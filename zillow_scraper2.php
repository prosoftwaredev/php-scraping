<?php
	...
	curl_setopt($page_scraper, CURLOPT_URL, 'https://www.zillow.com/homes/for_sale/72409914_zpid/45.352145,-76.475831,41.89001,-82.380982_rect/7_zm/1_fr/');
	...
	if ($url) {
		...
		$agent->Source = $agent_info_json_array[2];
		$agent->Phone_Number = $agent_info_json_array[3];

		$agent_info_json_result[] = $agent;

		$agent_info_json_result = json_encode($agent_info_json_result, JSON_PRETTY_PRINT);

		header('Content-disposition: attachment; filename=zillow_agent_list_2.json');
